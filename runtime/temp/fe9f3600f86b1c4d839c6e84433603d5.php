    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div style="position: relative;margin-bottom: 20px;margin-left: 20px;padding: 20px 20px 20px 20px">
                <h5>收信息邮箱：</h5>
                <input type="text" class="form-control" value="<?php echo $mail_inform; ?>" name="config_value">
                <br>
                <h5>邮箱通知模板：</h5>
                <lable>
                ...
                <textarea name="config_value_2" class="form-control"><?php echo $mail_inform; ?></textarea>
                <br>
                <?php if($mail_start == 1): ?>
