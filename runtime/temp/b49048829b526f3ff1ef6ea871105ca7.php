<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"D:\code_file\php\materialDownload\public/../application/admin\view\account.html";i:1528453315;s:71:"D:\code_file\php\materialDownload\application\admin\view\base\base.html";i:1528513302;s:42:"../application/admin/view/base/header.html";i:1528453315;s:43:"../application/admin/view/base/sidebar.html";i:1528453315;s:42:"../application/admin/view/base/footer.html";i:1528453315;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="" style="color:limegreen" data-toggle="modal" data-target="#modal-edit-<?php echo $single['account_id']; ?>">编辑</a>
                            <a href=""  style="color:limegreen" onclick="deleteEntity('<?php echo $single['account_id']; ?>')">删除</a>
                        </td>
                    </tr>

                    <div class="modal fade" id="modal-edit-<?php echo $single['account_id']; ?>">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="/admin/account/edit/<?php echo $single['account_id']; ?>" method="post">
                                    <div class="modal-body">
                                        <label>账号</label>
                                        <input type="text" class="form-control my-colorpicker1" name="account_number" value="<?php echo $single['account_number']; ?>">
                                        <br>
                                        <label>密码</label>
                                        <input type="text" class="form-control my-colorpicker1" name="password" value="<?php echo $single['password']; ?>">
                                        <br>
                                        <label>绑定的素材网站</label>
                                        <select name="type" class="form-control">
                                            <option value="">--</option>
                                            <?php if(!(empty($websiteList) || (($websiteList instanceof \think\Collection || $websiteList instanceof \think\Paginator ) && $websiteList->isEmpty()))): if(is_array($websiteList) || $websiteList instanceof \think\Collection || $websiteList instanceof \think\Paginator): $i = 0; $__LIST__ = $websiteList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$single2): $mod = ($i % 2 );++$i;if($single2['website_id'] == $single['type']): ?>
                                            <option value="<?php echo $single2['website_id']; ?>" selected="selected"><?php echo $single2['website_name']; ?></option>
                                            <?php else: ?>
                                            <option value="<?php echo $single2['website_id']; ?>"><?php echo $single2['website_name']; ?></option>
            ...
            <form action="/admin/user">
                <div class="modal-body">
                    ...
                    <select name="type2" class="form-control">
                        ...
                        <option value="<?php echo $single['website_id']; ?>"><?php echo $single['website_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                    </select>
                </div>
                <div class="modal-footer">
